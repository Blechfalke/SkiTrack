 ...
 * on 2014-12-05 at 09:21:44 UTC 
 * Modify at your own risk.
 */

package ch.technotracks.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<ch.technotracks.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, ch.technotracks.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link ch.technotracks.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(ch.technotracks.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<ch.technotracks.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(ch.technotracks.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, ch.technotracks.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<ch.technotracks.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, ch.technotracks.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(ch.technotracks.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<ch.technotracks.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(ch.technotracks.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, ch.technotracks.userendpoint.model.User.class);
    }
