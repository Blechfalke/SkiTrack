 ...
 * on 2014-12-05 at 09:21:17 UTC 
 * Modify at your own risk.
 */

package ch.technotracks.trackendpoint;
...
public class Trackendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetTrack extends TrackendpointRequest<ch.technotracks.trackendpoint.model.Track> {
    ...
    protected GetTrack(java.lang.Long id) {
      super(Trackendpoint.this, "GET", REST_PATH, null, ch.technotracks.trackendpoint.model.Track.class);
   ...
   *
   * @param content the {@link ch.technotracks.trackendpoint.model.Track}
   * @return the request
   */
  public InsertTrack insertTrack(ch.technotracks.trackendpoint.model.Track content) throws java.io.IOException {
    InsertTrack result = new InsertTrack(content);
    initialize(result);
    return result;
  }

  public class InsertTrack extends TrackendpointRequest<ch.technotracks.trackendpoint.model.Track> {
     ...
     * @since 1.13
     */
    protected InsertTrack(ch.technotracks.trackendpoint.model.Track content) {
      super(Trackendpoint.this, "POST", REST_PATH, content, ch.technotracks.trackendpoint.model.Track.class);
    }
  ...
  public class ListTrack extends TrackendpointRequest<ch.technotracks.trackendpoint.model.CollectionResponseTrack> {
     ...
     */
    protected ListTrack() {
      super(Trackendpoint.this, "GET", REST_PATH, null, ch.technotracks.trackendpoint.model.CollectionResponseTrack.class);
    }
   ...
   * @return the request
   */
  public UpdateTrack updateTrack(ch.technotracks.trackendpoint.model.Track content) throws java.io.IOException {
    UpdateTrack result = new UpdateTrack(content);
    initialize(result);
    return result;
  }

  public class UpdateTrack extends TrackendpointRequest<ch.technotracks.trackendpoint.model.Track> {
     ...
     * @since 1.13
     */
    protected UpdateTrack(ch.technotracks.trackendpoint.model.Track content) {
      super(Trackendpoint.this, "PUT", REST_PATH, content, ch.technotracks.trackendpoint.model.Track.class);
    }
